...
- [EAS Android build dependencies](eas-android-build-dependencies.md) — pnpm 11 cloud builds need explicit allowBuilds approvals and direct Babel preset dependencies.