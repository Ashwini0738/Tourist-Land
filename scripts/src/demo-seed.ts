...
const groups = [
  [users, demoUsers], [userRoles, roles], [vendorProfiles, [profile]], [destinations, demoDestinations],
  [attractions, demoAttractions], [foodPlaces, demoFoodPlaces], [events, demoEvents], [hotels, demoHotels],
  [hotelRooms, demoRooms], [roomAvailability, demoAvailability], [properties, demoProperties], [propertyEnquiries, demoEnquiries], [propertyEnquiryHistory, demoEnquiryHistory],
  [bookings, demoBookings], [bookingItems, demoBookingItems], [payments, demoPayments], [wallets, demoWallets],
  [walletTransactions, demoWalletTransactions], [reviews, demoReviews], [favorites, demoFavorites],
...
export async function resetDemoData() {
  ...
  const deletions = [
    [featuredContent, demoFeaturedContent], [notifications, demoNotifications], [favorites, demoFavorites], [reviews, demoReviews],
    [walletTransactions, demoWalletTransactions], [payments, demoPayments], [bookingItems, demoBookingItems], [bookings, demoBookings],
    [propertyEnquiryHistory, demoEnquiryHistory], [propertyEnquiries, demoEnquiries], [properties, demoProperties], [roomAvailability, demoAvailability], [hotelRooms, demoRooms],
    [hotels, demoHotels], [events, demoEvents], [foodPlaces, demoFoodPlaces], [attractions, demoAttractions], [destinations, demoDestinations],
