    ...
    <div className="app-shell min-h-[100dvh] text-foreground">
      ...
      <div className={`min-h-[100dvh] transition-[padding] duration-300 md:pl-[260px] ${collapsed ? 'md:pl-[76px]' : ''}`}>
        <header className="sticky top-0 z-20 flex h-[76px] items-center justify-between border-b border-border bg-background/90 px-5 backdrop-blur-md md:px-8">
          ...
          <div className="flex items-center gap-2"><button data-testid="button-help" className="hidden rounded-lg p-2 text-muted-foreground hover:bg-muted sm:block" title="Help"><CircleHelp size={18} /></button><div className="flex items-center gap-2 rounded-full border border-border bg-card px-2 py-1.5"><span className="h-2 w-2 rounded-full bg-[hsl(151_30%_43%)]" /><span className="hidden text-[11px] font-medium text-muted-foreground sm:inline">Systems nominal</span></div></div>
        </header>
