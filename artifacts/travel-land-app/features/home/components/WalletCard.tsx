...
export function WalletCard() {
  ...
  return (
    <LinearGradient
      colors={[colors.gradientSoft, colors.card, colors.secondary]}
      start={{ x: 0, y: 0 }}
      end={{ x: 1, y: 1 }}
    ...
    >
      ...
      <Pressable accessibilityRole="button" accessibilityLabel="Open wallet" onPress={() => router.push('/wallet')} style={styles.wallet}>
