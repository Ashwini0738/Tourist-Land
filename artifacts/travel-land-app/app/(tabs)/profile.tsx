...
export default function ProfileTab() {
  ...
  const { signOut, profile } = useMobileAuth();
  const { role } = useRole();
  const rows = [
...
const styles = StyleSheet.create({
  ...
  profileCard: { borderRadius: radii.lg, padding: spacing.md, flexDirection: 'row', alignItems: 'center', marginBottom: 14, overflow: 'hidden', ...elevation.card },
  ...
  profileSpark: { marginLeft: 'auto', width: 36, height: 36, borderRadius: 18, backgroundColor: 'rgba(255,255,255,0.12)', alignItems: 'center', justifyContent: 'center' },
