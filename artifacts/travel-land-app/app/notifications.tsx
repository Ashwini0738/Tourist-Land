...
export default function NotificationsScreen() {
  ...
  const enablePush = async () => {
    ...
    try {
      ...
      setPushMessage('This device is registered for future booking and enquiry updates.');
    } catch {
