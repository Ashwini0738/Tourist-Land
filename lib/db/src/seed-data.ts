...
export const demoReviews = [{ id: id("111", 1), userId: demoIds.users.traveller, entityType: "hotel", entityId: demoHotels[1].id, bookingId: demoBookings[1].id, rating: 5, title: "Wonderful stay", body: "A polished demo review.", status: "published" }];
